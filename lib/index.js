...
var Scroller = (function (_Component) {
  ...
  _createClass(Scroller, [{
    ...
    value: function prepareRenderProps(props) {
      ...
      var rest = _objectWithoutProperties(props, ['height', 'width', 'onMount', 'preventDefaultHorizontal', 'loadMask', 'loading', 'scrollbarSize', 'minVerticalScrollStep', 'scrollTop', 'scrollLeft', 'scrollHeight', 'scrollWidth', 'onVerticalScroll', 'onHorizontalScroll', 'virtualRendering', 'minScrollStep', 'minHorizontalScrollStep']);
